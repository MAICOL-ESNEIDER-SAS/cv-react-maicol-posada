README – EV05: Control de Versiones y Estructura del Proyecto React
...
5. Capturas de Evidencia EV05

A continuación, se presentan las capturas correspondientes a la estructura y commits del proyecto:

ESTRUCTURA DEL PROYECTO EN VISUAL

![Estructura del proyecto](img/pantallaso_estructura_visual_EVO5.png)

HISTORICO DE COMMITS EVO5

![Historial de commits EV05](img/pantallaso_historial_commits_EVO5.png)

6. Conclusión de la EV05

La evidencia EV05 permitió fortalecer el uso de Git y GitHub como herramientas esenciales en el desarrollo profesional de software.
...
Esta evidencia complementa y mejora el trabajo iniciado en la EV04, asegurando que el proyecto se mantenga limpio, escalable y fácil de mantener.